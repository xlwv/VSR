    ...
    <ul className="space-y-2 md:space-y-3">
      {items.map((item, i) => (
        <li key={i} className="flex items-start gap-2 md:gap-3">
          ...
          />
          <span
            className="text-[18px] text-[#404041]"
            style={{ fontFamily: '"Swis721 BT", sans-serif' }}
          >
            {item}
          </span>
        </li>
    ...
    <section className="w-full bg-white pt-4 pb-18">
      ...
      >
        ...
        <div className="w-full lg:w-[630px] space-y-4 md:space-y-5">
          ...
          <p
            className="para text-[#404041] lg:max-w-[520px]"
            style={{ fontFamily: '"Swis721 BT", sans-serif' }}
          >
            {description}
          </p>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-10">
            <div>
              <h3 className="text-[24px] font-serif mb-3 md:mb-4 text-gray-900">
                Benefits
              </h3>
              {renderList(benefits)}
            </div>
